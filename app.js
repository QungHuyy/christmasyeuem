...
$(document).ready(function () {
  var $card = $(".card"),
    ...
    let textTitle = "Gửi em bé lợn đột biến ^^";
    let charArrTitle = textTitle.split('');
let text = "Hôm nay là ngày kỉ niệm tròn 1 năm chúng mình yêu nhau, cũng là khoảnh khắc ngày Giáng Sinh an lành tới. Chúc cho mọi kỉ niệm, mọi cảm xúc vui hay buồn trong năm qua đều kết thúc 1 cách trọn vẹn, đều hạnh phúc vì 2 đứa vẫn nắm tay nhau bước tiếp. Những chuyện buồn ta đều nên để lại trong năm cũ, hành trình mới chúc cho 2 đứa vẫn yêu yêu thương, chăm sóc, coi nhau là mảnh ghép không thể thiếu. Cảm ơn em vì một năm nhiều ý nghĩa và giúp anh có được nhiều niềm hạnh phúc. Không dám sến súa hơn vì có các người anh support nên không thể dãi bày hết ở đây nữa hehe.  Chúc em bé 1 ngày Giáng Sinh đủ đầy - Happy Anniversary"
